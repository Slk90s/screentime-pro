...
> 最后更新：2026-09-18（**v0.9.1 已发布完成**：tag / commit `9ca1e62`；GitHub Release `391350602`
> 6 资产 / 240.5 MiB；Gitee Release `1151864` 5 附件 / 133.8 MiB，AppImage 111.9 MB 超 Gitee 单文件上限，
> 仅 GitHub 提供）
